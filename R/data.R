...
#' probabilities were generated from the \code{\link{dpeakdist}} function.
...
#' (\code{\link{ppeakdist}} and \code{\link{goldfeld_quandt}}) by default
#' obtain the probabilities from this data set rather than from
#' \code{\link{dpeakdist}}, provided that \eqn{n \leq 300}.
#'
#' @format A list with 300 objects. The \eqn{n}th object is a double vector
